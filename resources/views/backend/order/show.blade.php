...
<div class="card">
<h5 class="card-header">الطلب<a href="{{route('order.pdf',$order->id)}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> إنشاء ملف PDF</a>
  </h5>
  <div class="card-body">
    @if($order)
