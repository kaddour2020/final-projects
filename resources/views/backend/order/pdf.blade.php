...
<style type="text/css">
  ...
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          <th scope="col" class="col-6">المنتج</th>
          <th scope="col" class="col-3">الكمية</th>
          <th scope="col" class="col-3">المجموع</th>
        </tr>
      </thead>
      <tbody>
      ...
      <tfoot>
        <tr>
          <th scope="col" class="فارغة"></th>
          <th scope="col" class="text-right">المجموع الفرعي:</th>
          <th scope="col"> <span>${{number_format($order->sub_total,2)}}</span></th>
        </tr>
      {{-- @if(!empty($order->coupon))
        <tr>
          <th scope="col" class="فارغة"></th>
          <th scope="col" class="text-right">الخصومات:</th>
      ...
      @endif --}}
        <tr>
          ...
          @endphp
          <th scope="col" class="text-right ">الشحن:</th>
          <th><span>${{number_format($shipping_charge[0],2)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="فارغة"></th>
          <th scope="col" class="text-right">المجموع:</th>
          <th>
            <span>
  ...
  <div class="clearfix"></div>
@else
  <h5 class="text-danger">غير صالح</h5>
@endif
</body>
</html>