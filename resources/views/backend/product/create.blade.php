...
<div class="card">
    <h5 class="card-header">أضف منتج</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='1' checked> نعم                        
        </div>
              {{-- {{$categories}} --}}
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="أدخل السعر"  value="{{old('price')}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="أدخل الخصم"  value="{{old('discount')}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default">إفتراضي(Default)</option>
              <option value="new">جديد(New)</option>
              <option value="hot">مولع(Hot)</option>
          </select>
        </div>

        <div class="form-group">
          <label for="stock">الكمية <span class="text-danger">*</span></label>
          <input id="quantity" type="number" name="stock" min="0" placeholder="أدخل الكمية"  value="{{old('stock')}}" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
