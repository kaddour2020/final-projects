...
@section('title','المتجر العربي || العلامة التجارية')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">قائمة العلامات التجارية</h6>
      <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="إضافة المستخدم"><i class="fas fa-plus"></i> أضف العلامة التجارية</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">لا توجد ماركات !!! الرجاء إنشاء علامة تجارية</h6>
        @endif
      </div>
    </div>
</div>
