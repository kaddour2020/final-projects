...
@section('title','المتجر العربي || كل الإخطارات')
...
<div class="card">
  ...
  <h5 class="card-header">إشعارات</h5>
  <div class="card-body">
    ...
    <table class="table  table-hover admin-table" id="notification-dataTable">
      ...
      <tbody>
        ...
        <tr class="@if($notification->unread()) bg-light border-left-light @else border-left-success @endif">
          ...
          <td>
            <a href="{{route('admin.notification', $notification->id) }}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="تعديل" data-placement="bottom"><i class="fas fa-eye"></i></a>
