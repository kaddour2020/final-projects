...
<div class="card">
    <h5 class="card-header">أضف منشورا</h5>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">يقتبس</label>
        ...
        <div class="form-group">
          <label for="post_cat_id">الفئات <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="tags">شعار</label>
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--حدد علامة--</option>
...
<script>
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "اكتب تفاصيل الاقتباس .....",
          tabsize: 2,
          height: 100
      });
    });
