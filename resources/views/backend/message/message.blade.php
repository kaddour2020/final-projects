<div id="messages">
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            ...
            <div>
                <div class="text-truncate">هل أنا فتى جيد؟ سبب سؤالي هو أن أحدهم أخبرني أن الناس يقولون ذلك ، حتى لو لم يكونوا جيدين ...</div>
                <div class="small text-gray-500">Chicken the Dog · 2w</div>
            </div>
            </a> --}}
        </div>
        <a class="dropdown-item text-center small text-gray-500" href="{{route('message.index')}}">قراءة المزيد من الرسائل</a>
    </div>
</div>
