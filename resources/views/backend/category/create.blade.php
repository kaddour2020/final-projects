...
<div class="card">
    <h5 class="card-header">إضافة فئة</h5>
    <div class="card-body">
      <form method="post" action="{{route('category.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">الملخص</label>
