...
@section('title','المتجر العربي  || صفحة التسجيل')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">التسجيل</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2>التسجيل</h2>
                        <p>الرجاء التسجيل من اجل التسوق الذكي</p>
                        <!-- Form -->
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>تأكيد كلمة السر<span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        <button class="btn" type="submit">التسجيل</button>
                                        <a href="{{route('login.form')}}" class="btn">تسجيل الدخول</a>
                                        او
