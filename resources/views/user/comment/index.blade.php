...
@section('title','لصفحة الرئيسية || صفحة التعليقات')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">قوائم التعليق</h6>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($comments as $comment)
                <tr>
                    ...
                    <td>
                        <a href="{{route('user.post-comment.edit',$comment->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="تعديل" data-placement="bottom"><i class="fas fa-edit"></i></a>
